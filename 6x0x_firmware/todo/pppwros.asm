...
;__PPPWROS_________________________________________________________________________________________
;
;	WRITE OS ONTO BOOT TRACK OF SPECIFIED DEVICE
;
...
WRITEPPPBSEC  	.EQU	0	; WRITE OS TO SD CARD
WRITEFLPBSEC  	.EQU	0	; WRITE OS TO FLOPPY
WRITEIDEBSEC  	.EQU	1	; WRITE OS TO IDE DRIVE
