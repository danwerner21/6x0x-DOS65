...
''start vga
  if (!vga.start(BasePin, @screen, @colors, @cursor, @sync))
    return false
...
PUB cls1(c,screencolor,pcport,ascii,CR) | i,x,y
  ...
  clrbtm(TURQUOISE)
  clrbtm(BLUE)
  statprint(36,0,string("________________________________________________________________________________"))
'                       "01234567890123456789012345678901234567890123456789012345678901234567890123456789"
'                       "          1         2         3         4         5         6         7         "
  clrbtm(LAVENDER) 
  statprint(37,60,string("N8VEM PROJECT V0.1"))
  statprint(37,0 ,string("PROP TERM/BUS ATTACHED"))            
