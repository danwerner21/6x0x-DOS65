...
; Set the shop status-line pointer (shopstat) to a message address.
        ...
        STA     shopstat+1
        .ENDMACRO
; (Tile art in tiles.asm is now pre-packed .BYTE data - no row macro;
;  ca65 choked on a wide nibble-packing macro, so the nibbles were
;  packed to bytes at authoring time instead.)
