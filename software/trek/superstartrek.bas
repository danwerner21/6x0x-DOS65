...
2045 PRINT "IS PRESENTLY INCAPABLE OF CROSS";
...
2365 INPUT W1:IF D(1)<0 AND W1>.2 THEN 2470
...
3500 X=8*Q1+X+N*X1:
3501 Y=8*Q2+Y+N*X2:Q1=INT(X/8):Q2=INT(Y/8):S1=INT(X-Q1*8)
...
4000 IF D(3)<0 THEN PRINT "LONG RANGE SENSORS ARE INOP.":GOTO 1990
...
4270 PRINT "SCIENCE OFFICER REPORTS 'SENSORS SHOW NO ENEMY SHIPS"
...
4550 PRINT K(I,2)
4551 IF K(I,3)<=0 THEN PRINT "*** KLINGON DESTROYED ***":GOTO 4580
...
5110 PRINT "*** KLINGON DESTROYED ***":K3=K3-1:K9=K9-1
5111 IF K9<=0 THEN 6370
...
5370 PRINT "THAT DOES IT, YOU ARE HEREBY RELIEVED OF COMMAND"
...
5600 PRINT "SHIELD CONTROL REPORTS 'THIS IS NOT THE TREASURY.'"
...
6010 IF D0<>0 THEN PRINT "STARBASE SHIELDS PROTECT THE SHIP":RETURN
...
6331 IF A$="AYE" THEN 10
6360 END
6370 PRINT "CONGRADULATIONS, CAPTAIN! THEN LAST KLINGON "
...
6820 FOR J=(I-1)*24+1 TO (I-1)*24+22STEP3:PRINT " ";MID$(Q$,J,3);
6821 NEXT J
...
8500 IF B3<>0 THEN PRINT "FROM SHIP TO BASE:":W1=B4:X=B5:GOTO 8120
...
8590 R1=FNR(1):R2=FNR(1):A$="   ":
8591 Z1=R1:Z2=R2:GOSUB 8830:IF Z3=0 THEN 8590
8600 RETURN
