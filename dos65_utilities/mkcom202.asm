...
KIMPNT=$02+$50                  ;KIM RECORD INDEX
COMPNT=$03+$50                  ;COM RECORD POINTER
CURENT=$05+$50                  ;CURRENT COM PC
START=$07+$50                   ;CURRENT KIM START
COUNT=$09+$50                   ;CURRENT RECORD BYTE COUNT
BYTES=$0A+$50                   ;NUMBER BYTES READ
RECORD=$0C+$50                  ;NUMBER RECORDS READ
NUMBER=$0E+$50                  ;BYTE ASSEMBLY BUFFER
COMMAX=$0F+$50                  ;MAX COM POINTER
COMFCB=$20+$50                  ;COM FCB
LASTZP=$41+$50                  ;
...
;GET BYTE
GETTWO:
        JSR     GETONE          ;GET FIRST AND CONTINUE
;GET NIBBLE
GETONE:
        JSR     GETCHR          ;GET CHAR
...
;ERROR ROUTINES
INPERR:
        LDA     #<INERMS        ;INPUT FILE ERROR
        LDY     #>INERMS
        JMP     ERRSND
NTHXER:
        LDA     #>ICERMS        ;INVALID CHARACTER
        LDY     #<ICERMS
        JMP     ERRSND
OUTERR:
        LDA     #<OTERMS        ;OUTPUT FILE ERROR
        LDY     #>OTERMS
        JMP     ERRSND
SEQERR:
        LDA     #<SQERMS        ;SEQUENCE ERROR
        LDY     #>SQERMS
ERRSND:
        JSR     OUTBUF          ;SEND
...
INSERT:
        LDX     COMPNT          ;COMPARE LOW POINTER
        CPX     COMMAX          ;TO MAX
...
;MESSAGES
NXTADR:
        .BYTE   CR,LF,"NEXT ADDRESS=$"
BYTRDE:
        .BYTE   CR,LF,"BYTES READ=$"
RECWRT:
        .BYTE   CR,LF,"RECORDS WRITTEN=$"
;COM FILE BUFFER
MKCOMEND:
        .ORG    MKCOMEND/256*256+256
COMBUF:
        .END
