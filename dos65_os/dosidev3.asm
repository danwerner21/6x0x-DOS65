...
;*
	.IF ORIGINAL6X0X=1
IDELO	=      $F120		; DATA PORT (LOW BYTE)
IDEHI		=      $F121		; DATA PORT (HIGH BYTE)
IDECNTRL	=      $F122		; IDE CONTROL
IDEPPIC	=      $F123		; PPI CONTROL
	.ENDIF

	.IF COLOSSUS6X0X=1
IDELO		=       M6X0X_IOSPACE+$20	; DATA PORT (LOW BYTE)
IDEHI	=      M6X0X_IOSPACE+$21	; DATA PORT (HIGH BYTE)
IDECNTRL	=     M6X0X_IOSPACE+$22	; IDE CONTROL
IDEPPIC		=      M6X0X_IOSPACE+$23	; PPI CONTROL
	.ENDIF

IDE_A0_LINE	=	01H		;DIRECT FROM 8255 TO IDE INTERFACE
IDE_A1_LINE	=	02H		;DIRECT FROM 8255 TO IDE INTERFACE
IDE_A2_LINE	=	04H		;DIRECT FROM 8255 TO IDE INTERFACE
IDE_CS0_LINE	=	08H		;INVERTER BETWEEN 8255 AND IDE INTERFACE
IDE_CS1_LINE	=	10H		;INVERTER BETWEEN 8255 AND IDE INTERFACE
IDE_WR_LINE	=	20H		;INVERTER BETWEEN 8255 AND IDE INTERFACE
IDE_RD_LINE	=	40H		;INVERTER BETWEEN 8255 AND IDE INTERFACE
IDE_RST_LINE	=	80H		;INVERTER BETWEEN 8255 AND IDE INTERFACE
