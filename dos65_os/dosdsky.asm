...
DDRC	= 	$F023
	.ENDIF
	  ...
	  .IF COLOSSUS6X0X=1
DDRA		=	M6X0X_IOSPACE+$CF3
DDRB	 =	M6X0X_IOSPACE+$CF2
DDRC		= 	M6X0X_IOSPACE+$DF3
DDRD		=	M6X0X_IOSPACE+$DF2
PORTA		= 	M6X0X_IOSPACE+$CFF
PORTB		=	M6X0X_IOSPACE+$CF0
PORTC		= 	M6X0X_IOSPACE+$DFF
PORTD		= 	M6X0X_IOSPACE+$DF0
	.ENDIF
...
DISPLAYBUF:	.byte 	$84,$EE,$BB,$80,$BB,$EE,$CB,$84
DSKYDISPLAY:	.byte	$23,$45,$67,$89
